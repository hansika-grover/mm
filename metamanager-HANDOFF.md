...
1. metamanager-HANDOFF.md      — this file
2. metamanager-rebuild-NOTES.md    — original vision/notes
3. metamanager-research-report.md  — verified research + full capability matrix
4. metamanager-build-plan.md       — locked decisions, build steps 0–5, multi-profile graph solution
5. metamanager-one-pager.md        — plain-English explainer
...
"Read metamanager-HANDOFF.md and the docs in this folder. extractor.js works. Build the
